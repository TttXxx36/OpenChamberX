...
export const dict: Record<I18nKey, string> = {
  ...
  'layout.rightSidebar.actions.open': '오른쪽 사이드바 열기',
  'layout.rightSidebar.actions.close': '오른쪽 사이드바 닫기',
  'layout.services.instance': '인스턴스',
  'layout.services.usage': '사용량',
  'layout.presets.title': '레이아웃 프리셋',
  'layout.presets.description': '패널 레이아웃 구성을 저장하고 복원합니다.',
  'layout.presets.showStatusBar': '하단 상태 표시줄 표시',
  'layout.presets.showStatusBarAria': '상태 표시줄 가시성 전환',
  'layout.presets.presetNamePlaceholder': '프리셋 이름…',
  'layout.presets.saveCurrentLayout': '현재 레이아웃 저장',
  'layout.presets.empty': '아직 저장된 프리셋이 없습니다. 위에 이름을 입력하고 \'현재 레이아웃 저장\'을 클릭하세요.',
  'layout.presets.default': '기본값',
  'layout.presets.load': '불러오기',
  'layout.presets.deleteAria': '프리셋 "{name}" 삭제',
  'layout.presets.presetFull': '전체',
  'layout.presets.presetMinimal': '최소',
  'layout.presets.presetReview': '검토',
  ...
  'diffView.loadMore': '{count}개 더 보기',
  ...
  'diffView.scope.label': '파일 필터',
  'diffView.scope.ariaLabel': '변경된 파일 필터',
  'diffView.scope.working.label': '작업 트리',
  'diffView.scope.lastMessage.label': '마지막 메시지',
  'diffView.scope.empty.noMessage': '이 세션에 아직 어시스턴트 메시지가 없습니다.',
  'diffView.scope.empty.noEdits': '마지막 메시지에서 편집된 파일이 없습니다.',
  'diffView.scope.empty.noIntersection': '마지막 메시지에서 편집된 파일이 더 이상 작업 트리에 없습니다.',
  ...
  'session.githubPrPicker.actions.retry': '다시 시도',
  ...
  'voice.action.start': '음성 시작',
  'voice.action.startContinuous': '음성 시작(연속 모드 켜짐)',
  'voice.action.finishAndTranscribe': '음성 입력을 완료하고 받아쓰기',
  'voice.tooltip.stopConversation': '음성 대화 중지',
  'voice.tooltip.startConversation': '음성 대화 시작',
  'voice.tooltip.startConversationWithShortcut': '음성 대화 시작(Shift+클릭으로 연속 모드) • Cmd/Ctrl+Shift+V로 전환',
  'voice.support.secureContext': '음성 기능은 HTTPS 또는 localhost가 필요합니다. 보안 연결을 사용하세요.',
  'voice.support.recognitionUnsupported': '이 브라우저는 음성 인식을 지원하지 않습니다. Chrome, Edge 또는 Safari를 사용해 보세요.',
  'voice.support.synthesisUnsupported': '이 브라우저는 음성 합성을 지원하지 않습니다.',
  'voice.support.unsupported': '이 브라우저는 음성 기능을 지원하지 않습니다.',
  'voice.error.secureConnection': '음성 기능은 보안 연결(HTTPS) 또는 localhost가 필요합니다. HTTPS를 사용하거나 localhost로 접속하세요.',
  'voice.error.microphoneUnavailable': '이 런타임에서는 마이크에 접근할 수 없습니다. 데스크톱에서는 시스템 설정 -> 개인정보 보호 및 보안 -> 마이크에서 OpenChamber 권한을 확인하세요.',
  'voice.conversationMode.on': '연속 모드 켜짐',
  'voice.conversationMode.off': '연속 모드 꺼짐',
  ...
  'markdownRenderer.code.actions.showCode': '코드 보기',
  'markdownRenderer.code.actions.preview': '미리보기',
  'markdownRenderer.code.actions.previewHtml': 'HTML 미리보기',
  'markdownRenderer.code.actions.downloadHtml': 'HTML 다운로드',
  'markdownRenderer.code.actions.copied': '복사됨',
  'markdownRenderer.code.actions.copyCode': '코드 복사',
  'markdownRenderer.code.htmlPreviewTitle': 'HTML 미리보기',
  'markdownRenderer.file.openTitle': '파일 열기',
