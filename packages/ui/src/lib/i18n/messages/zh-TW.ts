...
export const dict: Record<I18nKey, string> = {
  ...
  'layout.rightSidebar.actions.open': '開啟右側邊欄',
  'layout.rightSidebar.actions.close': '關閉右側邊欄',
  'layout.services.instance': '實例',
  'layout.services.usage': '用量',
  'layout.presets.title': '佈局預設',
  'layout.presets.description': '儲存和恢復面板佈局配置。',
  'layout.presets.showStatusBar': '顯示底部狀態列',
  'layout.presets.showStatusBarAria': '切換狀態列可見性',
  'layout.presets.presetNamePlaceholder': '預設名稱…',
  'layout.presets.saveCurrentLayout': '儲存目前佈局',
  'layout.presets.empty': '暫無已儲存的預設。請在上方輸入名稱並點擊「儲存目前佈局」。',
  'layout.presets.default': '預設',
  'layout.presets.load': '載入',
  'layout.presets.deleteAria': '刪除預設「{name}」',
  'layout.presets.presetFull': '完整',
  'layout.presets.presetMinimal': '極簡',
  'layout.presets.presetReview': '審查',
  ...
  'session.githubPrPicker.actions.retry': '重試',
  ...
  'voice.action.start': '開始語音',
  'voice.action.startContinuous': '開始語音（連續模式已開啟）',
  'voice.action.finishAndTranscribe': '結束並轉錄語音輸入',
  'voice.tooltip.stopConversation': '停止語音對話',
  'voice.tooltip.startConversation': '開始語音對話',
  'voice.tooltip.startConversationWithShortcut': '開始語音對話（Shift+點擊切換連續模式）• Cmd/Ctrl+Shift+V 切換',
  'voice.support.secureContext': '語音需要 HTTPS 或 localhost。請使用安全連線。',
  'voice.support.recognitionUnsupported': '此瀏覽器不支援語音辨識。請嘗試 Chrome、Edge 或 Safari。',
  'voice.support.synthesisUnsupported': '此瀏覽器不支援語音合成。',
  'voice.support.unsupported': '此瀏覽器不支援語音。',
  'voice.error.secureConnection': '語音需要安全連線（HTTPS）或 localhost。請使用 HTTPS 或透過 localhost 存取。',
  'voice.error.microphoneUnavailable': '此執行環境無法存取麥克風。在桌面端，請檢查系統設定 -> 隱私權與安全性 -> 麥克風中的 OpenChamber 權限。',
  'voice.conversationMode.on': '連續模式已開啟',
  'voice.conversationMode.off': '連續模式已關閉',
  ...
  'onboarding.localSetup.windows.title': 'Windows 設定（推薦 WSL）',
  'onboarding.localSetup.windows.stepInstallWsl': '如需，請先在 PowerShell 中執行',
  'onboarding.localSetup.windows.stepInstallWslSuffix': '安裝 WSL。',
  'onboarding.localSetup.windows.stepRunInstallInWsl': '在 WSL 終端機中執行下方安裝命令。',
  ...
  'onboarding.localSetup.docs.windows': 'OpenCode Windows + WSL 文件',
  ...
  'onboarding.localSetup.windows.hintInstallInWsl': '在 Windows 上，建議在 WSL 中安裝並執行 OpenCode 以獲得最佳相容性。',
  'onboarding.localSetup.windows.hintDetectionFailed': '若偵測失敗，請設定本地路徑（opencode.cmd/opencode.exe）、wsl.exe，或 wsl:/usr/local/bin/opencode。',
  ...
  'diffView.loadMore': '显示 {count} 个更多文件',
  'diffView.scope.ariaLabel': '筛选已变更文件',
  'diffView.scope.empty.noEdits': '最近一条消息没有编辑任何文件。',
  'diffView.scope.empty.noIntersection': '最近一条消息编辑的文件已不在工作区中。',
  'diffView.scope.empty.noMessage': '当前会话还没有助手消息。',
  'diffView.scope.label': '筛选文件',
  'diffView.scope.lastMessage.label': '最近一条消息',
  'diffView.scope.working.label': '工作区',
  ...
  'markdownRenderer.code.actions.showCode': '顯示程式碼',
  'markdownRenderer.code.actions.preview': '預覽',
  'markdownRenderer.code.actions.previewHtml': '預覽 HTML',
  'markdownRenderer.code.actions.downloadHtml': '下載 HTML',
  'markdownRenderer.code.actions.copied': '已複製',
  'markdownRenderer.code.actions.copyCode': '複製程式碼',
  'markdownRenderer.code.htmlPreviewTitle': 'HTML 預覽',
  'markdownRenderer.file.openTitle': '開啟檔案',
};
