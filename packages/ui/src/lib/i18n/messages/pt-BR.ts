...
export const dict: Record<I18nKey, string> = {
 ...settingsDict,
  ...
  "layout.rightSidebar.actions.open": "Abrir barra lateral direita",
  "layout.rightSidebar.actions.close": "Fechar barra lateral direita",
  "layout.services.instance": "Instância",
  "layout.services.usage": "Uso",
  "layout.presets.title": "Predefinições de layout",
  "layout.presets.description": "Salvar e restaurar configurações de layout do painel.",
  "layout.presets.showStatusBar": "Mostrar barra de status inferior",
  "layout.presets.showStatusBarAria": "Alternar visibilidade da barra de status",
  "layout.presets.presetNamePlaceholder": "Nome da predefinição…",
  "layout.presets.saveCurrentLayout": "Salvar layout atual",
  "layout.presets.empty": "Nenhuma predefinição salva ainda. Digite um nome acima e clique em 'Salvar layout atual'.",
  "layout.presets.default": "Padrão",
  "layout.presets.load": "Carregar",
  "layout.presets.deleteAria": "Excluir predefinição \"{name}\"",
  "layout.presets.presetFull": "Completo",
  "layout.presets.presetMinimal": "Mínimo",
  "layout.presets.presetReview": "Revisão",
  ...
  "diffView.selector.filterPlaceholder": "Filtrar arquivos…",
  "diffView.selector.noMatches": "Sem arquivos correspondentes",
  ...
  "diffView.loadMore": "Mostrar mais {count} arquivos",
  ...
  "diffView.scope.label": "Filtrar arquivos",
  "diffView.scope.ariaLabel": "Filtrar arquivos modificados",
  "diffView.scope.working.label": "Worktree",
  "diffView.scope.lastMessage.label": "Última mensagem",
  "diffView.scope.empty.noMessage": "Ainda não há mensagem do assistente nesta sessão.",
  "diffView.scope.empty.noEdits": "A última mensagem não editou nenhum arquivo.",
  "diffView.scope.empty.noIntersection": "Os arquivos editados na última mensagem já não estão no worktree.",
  ...
  "session.githubPrPicker.actions.retry": "Tentar novamente",
  ...
  "voice.action.startContinuous": "Iniciar voz (modo contínuo ativado)",
  "voice.action.finishAndTranscribe": "Finalizar e transcrever a entrada de voz",
  "voice.tooltip.stopConversation": "Parar conversa por voz",
  "voice.tooltip.startConversation": "Iniciar conversa por voz",
  "voice.tooltip.startConversationWithShortcut": "Iniciar conversa por voz (Shift+clique para modo contínuo) • Cmd/Ctrl+Shift+V para alternar",
  "voice.support.secureContext": "A voz requer HTTPS ou localhost. Use uma conexão segura.",
  "voice.support.recognitionUnsupported": "Reconhecimento de fala não é compatível com este navegador. Tente Chrome, Edge ou Safari.",
  "voice.support.synthesisUnsupported": "Síntese de fala não é compatível com este navegador.",
  "voice.support.unsupported": "Voz não é compatível com este navegador.",
  "voice.error.secureConnection": "A voz requer uma conexão segura (HTTPS) ou localhost. Use HTTPS ou acesse via localhost.",
  "voice.error.microphoneUnavailable": "Acesso ao microfone indisponível neste runtime. No desktop, verifique Configurações do Sistema -> Privacidade e Segurança -> Microfone para OpenChamber.",
  "voice.conversationMode.on": "Modo contínuo ativado",
  "voice.conversationMode.off": "Modo contínuo desativado",
  ...
  "markdownRenderer.code.actions.preview": "Visualizar",
  "markdownRenderer.code.actions.previewHtml": "Visualizar HTML",
  "markdownRenderer.code.actions.downloadHtml": "Baixar HTML",
  "markdownRenderer.code.actions.copied": "Copiado",
  "markdownRenderer.code.actions.copyCode": "Copiar código",
  "markdownRenderer.code.htmlPreviewTitle": "Visualização HTML",
  "markdownRenderer.file.openTitle": "Abrir arquivo",
};
