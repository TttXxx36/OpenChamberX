...
export const dict: Record<I18nKey, string> = {
  ...
  'layout.rightSidebar.actions.open': 'Otwórz prawy pasek boczny',
  'layout.rightSidebar.actions.close': 'Zamknij prawy pasek boczny',
  'layout.services.instance': 'Instancja',
  'layout.services.usage': 'Użycie',
  'layout.presets.title': 'Predefinicje układu',
  'layout.presets.description': 'Zapisz i przywróć konfiguracje układu paneli.',
  'layout.presets.showStatusBar': 'Pokaż dolny pasek stanu',
  'layout.presets.showStatusBarAria': 'Przełącz widoczność paska stanu',
  'layout.presets.presetNamePlaceholder': 'Nazwa predefinicji…',
  'layout.presets.saveCurrentLayout': 'Zapisz bieżący układ',
  'layout.presets.empty': 'Nie ma jeszcze zapisanych predefinicji. Wpisz nazwę powyżej i kliknij \'Zapisz bieżący układ\'.',
  'layout.presets.default': 'Domyślny',
  'layout.presets.load': 'Wczytaj',
  'layout.presets.deleteAria': 'Usuń predefinicję "{name}"',
  'layout.presets.presetFull': 'Pełny',
  'layout.presets.presetMinimal': 'Minimalny',
  'layout.presets.presetReview': 'Przegląd',
  ...
  'voice.action.start': 'Rozpocznij głos',
  'voice.action.startContinuous': 'Rozpocznij głos (tryb ciągły włączony)',
  'voice.action.finishAndTranscribe': 'Zakończ i transkrybuj wejście głosowe',
  'voice.tooltip.stopConversation': 'Zatrzymaj rozmowę głosową',
  'voice.tooltip.startConversation': 'Rozpocznij rozmowę głosową',
  'voice.tooltip.startConversationWithShortcut': 'Rozpocznij rozmowę głosową (Shift+klik dla trybu ciągłego) • Cmd/Ctrl+Shift+V aby przełączyć',
  'voice.support.secureContext': 'Głos wymaga HTTPS lub localhost. Użyj bezpiecznego połączenia.',
  'voice.support.recognitionUnsupported': 'Rozpoznawanie mowy nie jest obsługiwane w tej przeglądarce. Spróbuj Chrome, Edge lub Safari.',
  'voice.support.synthesisUnsupported': 'Synteza mowy nie jest obsługiwana w tej przeglądarce.',
  'voice.support.unsupported': 'Głos nie jest obsługiwany w tej przeglądarce.',
  'voice.error.secureConnection': 'Głos wymaga bezpiecznego połączenia (HTTPS) lub localhost. Użyj HTTPS albo dostępu przez localhost.',
  'voice.error.microphoneUnavailable': 'Dostęp do mikrofonu jest niedostępny w tym runtime. Na desktopie sprawdź System Settings -> Privacy & Security -> Microphone dla OpenChamber.',
  'voice.conversationMode.on': 'Tryb ciągły włączony',
  'voice.conversationMode.off': 'Tryb ciągły wyłączony',
  ...
  'diffView.loadMore': 'Pokaż {count} więcej plików',
  ...
  'diffView.scope.label': 'Filtruj pliki',
  'diffView.scope.ariaLabel': 'Filtruj zmienione pliki',
  'diffView.scope.working.label': 'Drzewo robocze',
  'diffView.scope.lastMessage.label': 'Ostatnia wiadomość',
  'diffView.scope.empty.noMessage': 'W tej sesji nie ma jeszcze wiadomości asystenta.',
  'diffView.scope.empty.noEdits': 'Ostatnia wiadomość nie edytowała żadnych plików.',
  'diffView.scope.empty.noIntersection': 'Pliki edytowane w ostatniej wiadomości nie są już w drzewie roboczym.',
  ...
  'session.githubPrPicker.actions.retry': 'Ponów',
  ...
  'markdownRenderer.code.actions.showCode': 'Pokaż kod',
  'markdownRenderer.code.actions.preview': 'Podgląd',
  'markdownRenderer.code.actions.previewHtml': 'Podgląd HTML',
  'markdownRenderer.code.actions.downloadHtml': 'Pobierz HTML',
  'markdownRenderer.code.actions.copied': 'Skopiowano',
  'markdownRenderer.code.actions.copyCode': 'Kopiuj kod',
  'markdownRenderer.code.htmlPreviewTitle': 'Podgląd HTML',
  'markdownRenderer.file.openTitle': 'Otwórz plik',
} as const;
