...
export const dict = {
  ...
  'layout.presets.title': 'Layout Presets',
  'layout.presets.description': 'Save and restore panel layout configurations.',
  'layout.presets.showStatusBar': 'Show Bottom Status Bar',
  'layout.presets.showStatusBarAria': 'Toggle status bar visibility',
  'layout.presets.presetNamePlaceholder': 'Preset name…',
  'layout.presets.saveCurrentLayout': 'Save Current Layout',
  'layout.presets.empty': 'No saved presets yet. Enter a name above and click \'Save Current Layout\'.',
  'layout.presets.default': 'Default',
  'layout.presets.load': 'Load',
  'layout.presets.deleteAria': 'Delete preset "{name}"',
  'layout.presets.presetFull': 'Full',
  'layout.presets.presetMinimal': 'Minimal',
  'layout.presets.presetReview': 'Review',
  ...
  'diffView.loadMore': 'Show {count} more files',
  ...
  'diffView.scope.label': 'Filter files',
  'diffView.scope.ariaLabel': 'Filter changed files',
  'diffView.scope.working.label': 'Working tree',
  'diffView.scope.lastMessage.label': 'Last message',
  'diffView.scope.empty.noMessage': 'No assistant message in this session yet.',
  'diffView.scope.empty.noEdits': 'The last message did not edit any files.',
  'diffView.scope.empty.noIntersection': 'Files edited by the last message are no longer in the working tree.',
  ...
  'session.githubPrPicker.actions.retry': 'Retry',
  ...
  'voice.action.start': 'Start voice',
  'voice.action.startContinuous': 'Start voice (continuous mode on)',
  'voice.action.finishAndTranscribe': 'Finish and transcribe voice input',
  'voice.tooltip.stopConversation': 'Stop voice conversation',
  'voice.tooltip.startConversation': 'Start voice conversation',
  'voice.tooltip.startConversationWithShortcut': 'Start voice conversation (Shift+Click for continuous mode) • Cmd/Ctrl+Shift+V to toggle',
  'voice.support.secureContext': 'Voice requires HTTPS or localhost. Please use a secure connection.',
  'voice.support.recognitionUnsupported': 'Speech recognition is not supported in this browser. Try Chrome, Edge, or Safari.',
  'voice.support.synthesisUnsupported': 'Speech synthesis is not supported in this browser.',
  'voice.support.unsupported': 'Voice is not supported in this browser.',
  'voice.error.secureConnection': 'Voice requires a secure connection (HTTPS) or localhost. Please use HTTPS or access via localhost.',
  'voice.error.microphoneUnavailable': 'Microphone access is unavailable in this runtime. On desktop, check System Settings -> Privacy & Security -> Microphone for OpenChamber.',
  'voice.conversationMode.on': 'Continuous mode on',
  'voice.conversationMode.off': 'Continuous mode off',
  ...
  'markdownRenderer.code.htmlPreviewTitle': 'HTML preview',
  'markdownRenderer.file.openTitle': 'Open file',
