...
### **Desktop (Windows)**
Download from [Releases](https://github.com/TttXxx36/OpenChamberX/releases).
...
```bash
curl -fsSL https://raw.githubusercontent.com/TttXxx36/OpenChamberX/main/scripts/install.sh | bash
