...
export const dict: Record<I18nKey, string> = {
  ...
  "layout.rightSidebar.actions.open": "Abrir barra lateral derecha",
  "layout.rightSidebar.actions.close": "Cerrar barra lateral derecha",
  "layout.services.instance": "Instancia",
  "layout.services.usage": "Uso",
  "layout.presets.title": "Preestablecidos de diseño",
  "layout.presets.description": "Guardar y restaurar configuraciones de diseño del panel.",
  "layout.presets.showStatusBar": "Mostrar barra de estado inferior",
  "layout.presets.showStatusBarAria": "Alternar visibilidad de la barra de estado",
  "layout.presets.presetNamePlaceholder": "Nombre del preestablecido…",
  "layout.presets.saveCurrentLayout": "Guardar diseño actual",
  "layout.presets.empty": "Aún no hay preestablecidos guardados. Ingresa un nombre arriba y haz clic en 'Guardar diseño actual'.",
  "layout.presets.default": "Predeterminado",
  "layout.presets.load": "Cargar",
  "layout.presets.deleteAria": "Eliminar preestablecido \"{name}\"",
  "layout.presets.presetFull": "Completo",
  "layout.presets.presetMinimal": "Mínimo",
  "layout.presets.presetReview": "Revisión",
  ...
  "sessions.sidebar.session.rename.emptyTitle": "El nombre de la sesión no puede estar vacío",
  "sessions.sidebar.session.rename.error": "Error al cambiar el nombre de la sesión",
  ...
  "diffView.loadMore": "Mostrar {count} archivos más",
  ...
  "diffView.scope.label": "Filtrar archivos",
  "diffView.scope.ariaLabel": "Filtrar archivos modificados",
  "diffView.scope.working.label": "Árbol de trabajo",
  "diffView.scope.lastMessage.label": "Último mensaje",
  "diffView.scope.empty.noMessage": "Aún no hay mensajes del asistente en esta sesión.",
  "diffView.scope.empty.noEdits": "El último mensaje no editó ningún archivo.",
  "diffView.scope.empty.noIntersection": "Los archivos editados en el último mensaje ya no están en el árbol de trabajo.",
  ...
  "session.githubPrPicker.actions.retry": "Reintentar",
  ...
  "voice.action.start": "Iniciar voz",
  "voice.action.startContinuous": "Iniciar voz (modo continuo activado)",
  "voice.action.finishAndTranscribe": "Finalizar y transcribir la entrada de voz",
  "voice.tooltip.stopConversation": "Detener conversación de voz",
  "voice.tooltip.startConversation": "Iniciar conversación de voz",
  "voice.tooltip.startConversationWithShortcut": "Iniciar conversación de voz (Shift+clic para modo continuo) • Cmd/Ctrl+Shift+V para alternar",
  "voice.support.secureContext": "La voz requiere HTTPS o localhost. Usa una conexión segura.",
  "voice.support.recognitionUnsupported": "El reconocimiento de voz no es compatible con este navegador. Prueba Chrome, Edge o Safari.",
  "voice.support.synthesisUnsupported": "La síntesis de voz no es compatible con este navegador.",
  "voice.support.unsupported": "La voz no es compatible con este navegador.",
  "voice.error.secureConnection": "La voz requiere una conexión segura (HTTPS) o localhost. Usa HTTPS o accede vía localhost.",
  "voice.error.microphoneUnavailable": "El acceso al micrófono no está disponible en este entorno. En escritorio, revisa Configuración del sistema -> Privacidad y seguridad -> Micrófono para OpenChamber.",
  "voice.conversationMode.on": "Modo continuo activado",
  "voice.conversationMode.off": "Modo continuo desactivado",
  ...
  "markdownRenderer.code.actions.showCode": "Mostrar código",
  "markdownRenderer.code.actions.preview": "Vista previa",
  "markdownRenderer.code.actions.previewHtml": "Vista previa HTML",
  "markdownRenderer.code.actions.downloadHtml": "Descargar HTML",
  "markdownRenderer.code.actions.copied": "Copiado",
  "markdownRenderer.code.actions.copyCode": "Copiar código",
  "markdownRenderer.code.htmlPreviewTitle": "Vista previa HTML",
  "markdownRenderer.file.openTitle": "Abrir archivo",
};
