...
export const dict: Record<I18nKey, string> = {
  ...
  'layout.rightSidebar.actions.open': '打开右侧边栏',
  'layout.rightSidebar.actions.close': '关闭右侧边栏',
  'layout.services.instance': '实例',
  'layout.services.usage': '用量',
  'layout.presets.title': '布局预设',
  'layout.presets.description': '保存和恢复面板布局配置。',
  'layout.presets.showStatusBar': '显示底部状态栏',
  'layout.presets.showStatusBarAria': '切换状态栏可见性',
  'layout.presets.presetNamePlaceholder': '预设名称…',
  'layout.presets.saveCurrentLayout': '保存当前布局',
  'layout.presets.empty': '暂无已保存的预设。在上方输入名称并点击"保存当前布局"。',
  'layout.presets.default': '默认',
  'layout.presets.load': '加载',
  'layout.presets.deleteAria': '删除预设"{name}"',
  'layout.presets.presetFull': '完整',
  'layout.presets.presetMinimal': '极简',
  'layout.presets.presetReview': '审查',
  ...
  'session.githubPrPicker.actions.retry': '重试',
  ...
  'voice.action.start': '开始语音',
  'voice.action.startContinuous': '开始语音（连续模式已开启）',
  'voice.action.finishAndTranscribe': '结束并转写语音输入',
  'voice.tooltip.stopConversation': '停止语音对话',
  'voice.tooltip.startConversation': '开始语音对话',
  'voice.tooltip.startConversationWithShortcut': '开始语音对话（Shift+点击切换连续模式）• Cmd/Ctrl+Shift+V 切换',
  'voice.support.secureContext': '语音需要 HTTPS 或 localhost。请使用安全连接。',
  'voice.support.recognitionUnsupported': '此浏览器不支持语音识别。请尝试 Chrome、Edge 或 Safari。',
  'voice.support.synthesisUnsupported': '此浏览器不支持语音合成。',
  'voice.support.unsupported': '此浏览器不支持语音。',
  'voice.error.secureConnection': '语音需要安全连接（HTTPS）或 localhost。请使用 HTTPS 或通过 localhost 访问。',
  'voice.error.microphoneUnavailable': '此运行时无法访问麦克风。在桌面端，请检查系统设置 -> 隐私与安全 -> 麦克风中的 OpenChamber 权限。',
  'voice.conversationMode.on': '连续模式已开启',
  'voice.conversationMode.off': '连续模式已关闭',
  ...
  'markdownRenderer.code.htmlPreviewTitle': 'HTML 预览',
  'markdownRenderer.file.openTitle': '打开文件',
};
